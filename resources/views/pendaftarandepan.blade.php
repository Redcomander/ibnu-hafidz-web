        ...
        <div class="biaya-container">
            ...
            <div class="administrasi-card" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="administrasi-content">
                    ...
                    <div class="administrasi-row">
                        <div class="administrasi-label">Laundry</div>
                    ...
                    <div class="administrasi-total">
                        <div class="administrasi-label">Total</div>
                        <div class="administrasi-total-value">Rp. 1.070.000</div>
                    </div>
                </div>
            </div>

            <div class="biaya-note" data-aos="fade-up" data-aos-delay="300">
                <strong>Catatan:</strong> Biaya awal dibayarkan satu kali saat pendaftaran, sementara biaya bulanan
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-4" data-aos="fade-up" data-aos-delay="300">
                ...
                <div class="accordion-item bg-gray-50 rounded-xl overflow-hidden shadow-sm">
                    ...
                    <div class="accordion-content max-h-0 overflow-hidden transition-all duration-500 ease-in-out">
                        <div class="p-6 pt-0 text-gray-600">
                            Persyaratan yang harus disiapkan antara lain: fotokopi akta kelahiran, kartu keluarga, rapor
                            terakhir, pas foto, dan surat keterangan sehat dari dokter.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item bg-gray-50 rounded-xl overflow-hidden shadow-sm">
                    ...
                    <div class="accordion-content max-h-0 overflow-hidden transition-all duration-500 ease-in-out">
                        <div class="p-6 pt-0 text-gray-600">
                            Proses seleksi meliputi tes baca Al-Qur'an, tes pengetahuan agama dasar, dan wawancara dengan
                            calon santri dan orang tua/wali.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item bg-gray-50 rounded-xl overflow-hidden shadow-sm">
                    <button
                        class="accordion-header w-full flex justify-between items-center p-6 text-left focus:outline-none">
                        <h3 class="text-xl font-semibold text-gray-800">Kapan pengumuman hasil seleksi?</h3>
                        <svg class="accordion-icon w-6 h-6 text-green-600 transform transition-transform duration-300"
                            fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                    ...
                    <div class="accordion-content max-h-0 overflow-hidden transition-all duration-500 ease-in-out">
                        <div class="p-6 pt-0 text-gray-600">
                            Pengumuman hasil seleksi akan diinformasikan maksimal 7 hari kerja setelah proses seleksi
                            dilakukan. Hasil akan dikirimkan melalui WhatsApp dan email yang telah didaftarkan.
                        </div>
                    </div>
                </div>
    ...
    <section id="form-pendaftaran" class="py-16 md:py-24 bg-gray-50">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="steps-container" data-aos="fade-up" data-aos-delay="300">
                ...
                <div class="step" data-step="verifikasi">
                    2
            ...
            <div id="registration-form-container">
                ...
                <!-- Step 2: Verifikasi -->
                <div class="step-section" id="step-verifikasi">
                    <div class="info-card" data-aos="fade-up" data-aos-delay="400">
                        <div class="info-card-title">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                ...
                                <div>
                                    ...
                                    <div class="space-y-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="font-medium" id="verifikasi-ttl"></p>
                                        </div>
                                        <div>
                            ...
                            <div class="border-t border-gray-200 pt-6 mt-6">
                                <div class="flex items-center mb-6">
                                    ...
                                    <p class="text-gray-700">
                                        Dengan melanjutkan, saya menyatakan bahwa data yang saya masukkan adalah benar dan
                                        dapat
                                ...
                                <div class="mt-8 text-center">
                                    <button class="submit-btn" id="submit-verifikasi">
                                        <span id="verifikasi-submit-text">Lanjutkan ke Pembayaran</span>
                                        <span id="verifikasi-loading" style="display: none;">
                ...
                <!-- Step 4: Selesai -->
                <div class="step-section" id="step-selesai">
                    <div class="form-container" data-aos="fade-up" data-aos-delay="500">
                        <div class="form-body text-center py-12">
                            ...
                            <div class="bg-gray-50 p-6 rounded-lg mb-8 max-w-md mx-auto">
                                ...
                                <p class="text-2xl font-bold text-green-600 mb-4" id="nomor-pendaftaran">PSB-0000</p>
                            ...
                            <p class="text-gray-700 font-medium mb-4">Klik ini untuk menyelesaikan pendaftaran</p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function showStep(stepId) {
                ...
                const steps = ['formulir', 'verifikasi', 'pembayaran', 'selesai'];
            ...
            // Replace the JavaScript section in your pendaftarandepan.blade.php file
                ...
                fetch('/pendaftaran', {
                    ...
                    .then(data => {
                        if (data.errors) {
                            ...
                            // Populate verification step with the data
                            document.getElementById('verifikasi-nama').textContent = data.nama;
                            document.getElementById('verifikasi-ttl').textContent = `${data.tempat_lahir}, ${new Date(data.tanggal_lahir).toLocaleDateString('id-ID')}`;
                            document.getElementById('verifikasi-jenis-kelamin').textContent = data.jenis_kelamin;
                            document.getElementById('verifikasi-alamat').textContent = data.alamat;
                            document.getElementById('verifikasi-nama-ayah').textContent = data.nama_ayah;
                            document.getElementById('verifikasi-nama-ibu').textContent = data.nama_ibu;
                            document.getElementById('verifikasi-no-whatsapp').textContent = data.no_whatsapp;
                            document.getElementById('verifikasi-asal-sekolah').textContent = data.asal_sekolah;
            ...
            document.getElementById('submit-verifikasi').addEventListener('click', function () {
                // Show loading state
                document.getElementById('verifikasi-submit-text').style.display = 'none';
                document.getElementById('verifikasi-loading').style.display = 'inline-block';

                // Send AJAX request
                fetch('/pendaftaran/verifikasi', {
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                    ...
                    .finally(() => {
                        // Hide loading state
                        document.getElementById('verifikasi-submit-text').style.display = 'inline-block';
                        document.getElementById('verifikasi-loading').style.display = 'none';
                    });
            });
                ...
                fetch('/pendaftaran/pembayaran', {
                    ...
                    .then(data => {
                        if (data.errors) {
                            ...
                            document.getElementById('nomor-pendaftaran').textContent = `PSB-${calonSantriId.toString().padStart(4, '0')}`;
