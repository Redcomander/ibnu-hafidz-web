...
@section('content')
    <div class="min-h-screen py-6 dark:bg-gray-900 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="relative rounded-2xl overflow-hidden mb-8 animate-fadeIn" style="animation-delay: 0.1s;">
                <div
                    class="absolute inset-0 bg-gradient-to-r from-green-600 to-green-400 dark:from-green-800 dark:to-green-600">
                </div>
                <div class="absolute inset-0 opacity-20 bg-pattern"></div>

                <div
                    class="relative z-10 px-6 py-8 md:px-10 md:py-12 flex flex-col md:flex-row justify-between items-start md:items-center">
                    <div class="flex-1">
                        <div class="flex items-center mb-4">
                            <a href="{{ route('pendaftaran.index') }}"
                                class="bg-white/20 hover:bg-white/30 text-white p-2 rounded-full transition-all duration-200 mr-4">
                        ...
                        <div class="flex flex-wrap gap-2 mt-4">
                            @if($calonSantri->status == 'formulir')
                                <span
                                    class="px-3 py-1 inline-flex items-center text-xs md:text-sm leading-5 font-semibold rounded-full bg-yellow-100 text-yellow-800 status-indicator status-formulir pl-6">
                                    Formulir
                                </span>
                            @elseif($calonSantri->status == 'checking')
                                <span
                                    class="px-3 py-1 inline-flex items-center text-xs md:text-sm leading-5 font-semibold rounded-full bg-purple-100 text-purple-800 status-indicator status-verifikasi pl-6">
                                    Verifikasi
                                </span>
                            @elseif($calonSantri->status == 'pembayaran')
                                <span
                                    class="px-3 py-1 inline-flex items-center text-xs md:text-sm leading-5 font-semibold rounded-full bg-blue-100 text-blue-800 status-indicator status-pembayaran pl-6">
                                    Pembayaran
                                </span>
                            @elseif($calonSantri->status == 'berhasil')
                                <span
                                    class="px-3 py-1 inline-flex items-center text-xs md:text-sm leading-5 font-semibold rounded-full bg-green-100 text-green-800 status-indicator status-selesai pl-6">
                                    Selesai
                                </span>
                            @endif
                            ...
                            @if($calonSantri->payment_type == 'Lunas')
                                <span
                                    class="px-3 py-1 inline-flex items-center text-xs md:text-sm leading-5 font-semibold rounded-full bg-green-100 text-green-800">
                            ...
                            @elseif($calonSantri->payment_type == 'Cicilan')
                                <span
                                    class="px-3 py-1 inline-flex items-center text-xs md:text-sm leading-5 font-semibold rounded-full bg-orange-100 text-orange-800">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24"
                                        stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden hover-card-effect animate-fadeIn"
                        ...
                        <div
                            ...
                            <h3 class="text-lg font-medium text-gray-800 dark:text-white flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="h-5 w-5 mr-2 text-green-600 dark:text-green-400" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="p-6">
                            <div class="relative flex items-center justify-between mb-12">
                                ...
                                <div class="relative z-10 flex flex-col items-center">
                                    <div
                                        class="{{ in_array($calonSantri->status, ['formulir', 'checking', 'pembayaran', 'berhasil', 'Formulir', 'Verifikasi', 'Pembayaran', 'Selesai']) ? 'bg-green-500' : 'bg-gray-300 dark:bg-gray-600' }} rounded-full h-10 w-10 flex items-center justify-center text-white font-bold">
                                        @if(in_array($calonSantri->status, ['formulir', 'checking', 'pembayaran', 'berhasil', 'Formulir', 'Verifikasi', 'Pembayaran', 'Selesai']))
                                ...
                                <!-- Step 2: Verifikasi/Checking -->
                                <div class="relative z-10 flex flex-col items-center">
                                    <div
                                        class="{{ in_array($calonSantri->status, ['checking', 'pembayaran', 'berhasil', 'Verifikasi', 'Pembayaran', 'Selesai']) ? 'bg-green-500' : 'bg-gray-300 dark:bg-gray-600' }} rounded-full h-10 w-10 flex items-center justify-center text-white font-bold">
                                        @if(in_array($calonSantri->status, ['checking', 'pembayaran', 'berhasil', 'Verifikasi', 'Pembayaran', 'Selesai']))
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                                                viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M5 13l4 4L19 7" />
                                    ...
                                    <span
                                        class="text-xs font-medium mt-2 text-gray-600 dark:text-gray-400">Verifikasi</span>
                                </div>

                                <!-- Step 3: Pembayaran -->
                                <div class="relative z-10 flex flex-col items-center">
                                    <div
                                        class="{{ in_array($calonSantri->status, ['pembayaran', 'berhasil', 'Pembayaran', 'Selesai']) ? 'bg-green-500' : 'bg-gray-300 dark:bg-gray-600' }} rounded-full h-10 w-10 flex items-center justify-center text-white font-bold">
                                        @if(in_array($calonSantri->status, ['pembayaran', 'berhasil', 'Pembayaran', 'Selesai']))
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                                                viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M5 13l4 4L19 7" />
                                    ...
                                    <span
                                        class="text-xs font-medium mt-2 text-gray-600 dark:text-gray-400">Pembayaran</span>
                                </div>

                                <!-- Step 4: Selesai/Berhasil -->
                                <div class="relative z-10 flex flex-col items-center">
                                    <div
                                        class="{{ in_array($calonSantri->status, ['berhasil', 'Selesai']) ? 'bg-green-500' : 'bg-gray-300 dark:bg-gray-600' }} rounded-full h-10 w-10 flex items-center justify-center text-white font-bold">
                                        @if(in_array($calonSantri->status, ['berhasil', 'Selesai']))
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                                                viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M5 13l4 4L19 7" />
                            ...
                            <div class="mt-8 flex flex-wrap gap-3 justify-center">
                                ...
                                @if($calonSantri->status == 'checking')
                                    ...
                                    <form action="{{ route('pendaftaran.pembayaran') }}" method="POST">
                                        @csrf
                                        <input type="hidden" name="calon_santri_id" value="{{ $calonSantri->id }}">
                                        <input type="hidden" name="payment_type" value="Cicilan">
                                        <input type="hidden" name="admin_action" value="1">
                                        <button type="submit"
                                            class="bg-orange-600 hover:bg-orange-700 dark:bg-orange-700 dark:hover:bg-orange-800 text-white px-4 py-2 rounded-lg transition-all duration-200 flex items-center gap-2 btn-hover-effect">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none"
                                                viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                ...
                                @if($calonSantri->status == 'pembayaran')
                                    <form action="{{ route('pendaftaran.update', $calonSantri->id) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                    ...
                                    <div class="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg">
                                        ...
                                        <div class="relative overflow-hidden rounded-lg h-48 bg-gray-200 dark:bg-gray-700">
                                            <a href="{{ route('pendaftaran.viewPaymentProof', $calonSantri->id) }}"
                                                ...
                                                <img src="{{ asset('storage/' . $calonSantri->payment_proof) }}"
                                                    alt="Bukti Pembayaran"
                                                    class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                                                <div
                                                    class="absolute inset-0 bg-black bg-opacity-20 opacity-0 hover:opacity-100 flex items-center justify-center transition-opacity duration-300">
                        ...
                        <div class="p-6">
                            <div class="space-y-3">
                                ...
                                <button type="button" onclick="printData()"
                                    class="w-full bg-purple-600 hover:bg-purple-700 dark:bg-purple-700 dark:hover:bg-purple-800 text-white px-4 py-3 rounded-lg transition-all duration-200 flex items-center justify-center gap-2 btn-hover-effect">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                                        stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <script>
        ...
        function printData() {
            ...
            const regNumber = "{{ $calonSantri->nomor_pendaftaran }}";
