        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            <div class="mb-8 animate__animated animate__fadeIn">
                ...
                <div
                    ...
                    <div class="flex flex-wrap gap-2 mt-4">
                        <div
                            class="category-pill px-3 py-1.5 rounded-full bg-gradient-to-r from-purple-500 to-blue-500 text-white text-xs font-medium shadow-sm shadow-purple-500/20 cursor-pointer">
                            All Categories
                        </div>
                        <div
                            class="category-pill px-3 py-1.5 rounded-full bg-white/70 dark:bg-slate-700/70 text-slate-700 dark:text-slate-300 text-xs font-medium shadow-sm border border-slate-200 dark:border-slate-600 cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-600">
                            Technology
                        </div>
                        <div
                            class="category-pill px-3 py-1.5 rounded-full bg-white/70 dark:bg-slate-700/70 text-slate-700 dark:text-slate-300 text-xs font-medium shadow-sm border border-slate-200 dark:border-slate-600 cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-600">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @forelse($articles as $article)
                    <div
                        class="article-card bg-white/70 dark:bg-slate-800/50 rounded-xl shadow-lg border border-slate-200/50 dark:border-slate-700/30 overflow-hidden glass-effect animate__animated animate__fadeInUp">
                        <!-- Article thumbnail -->
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="article-actions flex space-x-1">
                                    ...
                                    <form action="{{ route('articles.destroy', $article->id) }}" method="POST" class="inline"
                                        ...
                                        @method('DELETE')
                                        <button type="submit"
                                            class="tooltip p-2 rounded-lg text-red-600 hover:text-red-800 dark:text-red-400 dark:hover:text-red-300 bg-red-100 dark:bg-red-900/30 hover:bg-red-200 dark:hover:bg-red-900/50"
                                            title="Delete">
