    ...
    <div class="stats-card dashboard-card p-6 glass-effect">
        <div class="flex items-center">
            ...
            <div class="ml-5">
                ...
                <h3 class="text-2xl font-bold text-gray-800 dark:text-gray-100">660</h3>
            </div>
        </div>
        <div class="mt-4">
            <div class="flex items-center">
                <span class="text-green-600 dark:text-green-500 text-sm font-medium flex items-center">
    ...
    <div class="stats-card dashboard-card p-6 glass-effect">
        <div class="flex items-center">
            ...
            <div class="ml-5">
                ...
                <h3 class="text-2xl font-bold text-gray-800 dark:text-gray-100">30</h3>
            </div>
        </div>
        <div class="mt-4">
            <div class="flex items-center">
    ...
    <div class="stats-card dashboard-card p-6 glass-effect">
        <div class="flex items-center">
            ...
            <div class="ml-5">
                ...
                <h3 class="text-2xl font-bold text-gray-800 dark:text-gray-100">45</h3>
            </div>
        </div>
        <div class="mt-4">
            <div class="flex items-center">
    ...
    <div class="stats-card dashboard-card p-6 glass-effect animate-pulse-glow">
        <div class="flex items-center">
            ...
            <div class="ml-5">
                ...
                <h3 class="text-2xl font-bold text-gray-800 dark:text-gray-100" id="total-visitors">12,845</h3>
            </div>
        </div>
        <div class="mt-4">
            <div class="flex items-center">
...
<div class="dashboard-card p-6 mb-8 glass-effect animate__animated animate__fadeIn">
    <div class="flex flex-col md:flex-row md:items-center justify-between mb-6">
        <div>
            ...
            <p class="text-gray-500 dark:text-gray-400 text-sm mt-1">Analisis trafik pengunjung website pondok pesantren</p>
        </div>

        <div class="flex flex-wrap gap-2 mt-4 md:mt-0">
            <button data-period="day" class="filter-button px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:shadow-md">
                Hari Ini
            </button>
            <button data-period="week" class="filter-button px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 filter-active shadow-lg">
                Minggu Ini
            </button>
            <button data-period="month" class="filter-button px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:shadow-md">
                Bulan Ini
            </button>
            <button data-period="year" class="filter-button px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:shadow-md">
                Tahun Ini
            </button>
        </div>
    </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-4 h-full">
                ...
                <div class="space-y-6">
                    <div>
                        <div class="flex justify-between items-center mb-1">
                            ...
                            <span class="text-sm font-medium text-gray-700 dark:text-gray-300" id="active-visitors">24</span>
                        </div>
                ...
                <div class="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-xs font-medium text-gray-700 dark:text-gray-300" id="last-updated">Baru saja</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-4">
            ...
            <div class="space-y-4">
                <div class="flex items-center">
                    ...
                    <div class="flex-1">
                        <div class="flex justify-between items-center mb-1">
                            <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Pengunjung Langsung</span>
                            <span class="text-sm font-medium text-gray-700 dark:text-gray-300" id="direct-visitors">4,721</span>
                        </div>
                        <div class="progress-bar">
                            <div class="progress-value bg-green-500" id="direct-progress" style="width: 38%"></div>
                        </div>
                        <div class="flex justify-between items-center mt-1">
                            <span class="text-xs text-gray-500 dark:text-gray-400" id="direct-percentage">38% dari total</span>
                ...
                <div class="flex items-center">
                    ...
                    <div class="flex-1">
                        <div class="flex justify-between items-center mb-1">
                            ...
                            <span class="text-sm font-medium text-gray-700 dark:text-gray-300" id="organic-visitors">3,952</span>
                        </div>
                        <div class="progress-bar">
                            <div class="progress-value bg-blue-500" id="organic-progress" style="width: 31%"></div>
                        </div>
                        <div class="flex justify-between items-center mt-1">
                            <span class="text-xs text-gray-500 dark:text-gray-400" id="organic-percentage">31% dari total</span>
                ...
                <div class="flex items-center">
                    <div class="w-10 h-10 rounded-lg bg-purple-100 dark:bg-purple-900/30 flex items-center justify-center mr-4">
                        <svg class="h-5 w-5 text-purple-600 dark:text-purple-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="flex-1">
                        <div class="flex justify-between items-center mb-1">
                            ...
                            <span class="text-sm font-medium text-gray-700 dark:text-gray-300" id="social-visitors">2,442</span>
                        </div>
                        <div class="progress-bar">
                            <div class="progress-value bg-purple-500" id="social-progress" style="width: 19%"></div>
                        </div>
                        <div class="flex justify-between items-center mt-1">
                            <span class="text-xs text-gray-500 dark:text-gray-400" id="social-percentage">19% dari total</span>
                ...
                <div class="flex items-center">
                    <div class="w-10 h-10 rounded-lg bg-amber-100 dark:bg-amber-900/30 flex items-center justify-center mr-4">
                    ...
                    <div class="flex-1">
                        <div class="flex justify-between items-center mb-1">
                            ...
                            <span class="text-sm font-medium text-gray-700 dark:text-gray-300" id="referral-visitors">1,730</span>
                        </div>
                        <div class="progress-bar">
                            <div class="progress-value bg-amber-500" id="referral-progress" style="width: 12%"></div>
                        </div>
                        <div class="flex justify-between items-center mt-1">
                            <span class="text-xs text-gray-500 dark:text-gray-400" id="referral-percentage">12% dari total</span>
                ...
                <div class="flex items-center">
                    ...
                    <div class="flex-1">
                        <div class="flex justify-between items-center mb-1">
                            ...
                            <span class="text-sm font-medium text-gray-700 dark:text-gray-300" id="mobile-visitors">7,842</span>
                        </div>
                        <div class="progress-bar">
                            <div class="progress-value bg-blue-500" id="mobile-progress" style="width: 62%"></div>
                        </div>
                        <div class="flex justify-between items-center mt-1">
                            <span class="text-xs text-gray-500 dark:text-gray-400" id="mobile-percentage">62% dari total</span>
                ...
                <div class="flex items-center">
                    ...
                    <div class="flex-1">
                        <div class="flex justify-between items-center mb-1">
                            ...
                            <span class="text-sm font-medium text-gray-700 dark:text-gray-300" id="desktop-visitors">3,954</span>
                        </div>
                        <div class="progress-bar">
                            <div class="progress-value bg-purple-500" id="desktop-progress" style="width: 31%"></div>
                        </div>
                        <div class="flex justify-between items-center mt-1">
                            <span class="text-xs text-gray-500 dark:text-gray-400" id="desktop-percentage">31% dari total</span>
                ...
                <div class="flex items-center">
                    ...
                    <div class="flex-1">
                        <div class="flex justify-between items-center mb-1">
                            ...
                            <span class="text-sm font-medium text-gray-700 dark:text-gray-300" id="tablet-visitors">889</span>
                        </div>
                        <div class="progress-bar">
                            <div class="progress-value bg-green-500" id="tablet-progress" style="width: 7%"></div>
                        </div>
                        <div class="flex justify-between items-center mt-1">
                            <span class="text-xs text-gray-500 dark:text-gray-400" id="tablet-percentage">7% dari total</span>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-4">
            ...
            <div class="grid grid-cols-2 gap-4 mt-4">
                <div>
                    <h4 class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Kota Teratas</h4>
                    <ul class="space-y-2">
                        <li class="flex justify-between items-center">
                            <span class="text-sm text-gray-700 dark:text-gray-300">Jakarta</span>
                            <span class="text-sm font-medium text-gray-700 dark:text-gray-300">42%</span>
                        </li>
                        <li class="flex justify-between items-center">
                            <span class="text-sm text-gray-700 dark:text-gray-300">Surabaya</span>
                            <span class="text-sm font-medium text-gray-700 dark:text-gray-300">18%</span>
                        </li>
                        <li class="flex justify-between items-center">
                            <span class="text-sm text-gray-700 dark:text-gray-300">Bandung</span>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li class="flex justify-between items-center">
                            ...
                            <span class="text-sm font-medium text-gray-700 dark:text-gray-300">89%</span>
                        </li>
                        <li class="flex justify-between items-center">
                            <span class="text-sm text-gray-700 dark:text-gray-300">Malaysia</span>
                            <span class="text-sm font-medium text-gray-700 dark:text-gray-300">5%</span>
                        </li>
                        <li class="flex justify-between items-center">
                            <span class="text-sm text-gray-700 dark:text-gray-300">Singapura</span>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-4">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full">
                    <thead>
                        <tr>
                            <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Halaman</th>
                            <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Pengunjung</th>
                            <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Bounce Rate</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        <tr>
                            <td class="px-4 py-3">
                                <div class="flex items-center">
                                    <div class="w-6 h-6 rounded bg-green-100 dark:bg-green-900/30 flex items-center justify-center mr-3">
                                        <svg class="h-3 w-3 text-green-600 dark:text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <tr>
                            <td class="px-4 py-3">
                                <div class="flex items-center">
                                    <div class="w-6 h-6 rounded bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center mr-3">
                                        <svg class="h-3 w-3 text-blue-600 dark:text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <tr>
                            <td class="px-4 py-3">
                                <div class="flex items-center">
                                    <div class="w-6 h-6 rounded bg-purple-100 dark:bg-purple-900/30 flex items-center justify-center mr-3">
                                        <svg class="h-3 w-3 text-purple-600 dark:text-purple-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <tr>
                            <td class="px-4 py-3">
                                <div class="flex items-center">
                                    <div class="w-6 h-6 rounded bg-amber-100 dark:bg-amber-900/30 flex items-center justify-center mr-3">
                                        <svg class="h-3 w-3 text-amber-600 dark:text-amber-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        try {
            const map = new jsVectorMap({
                ...
                markers: [
                    ...
                    { name: 'Kuala Lumpur', coords: [101.6869, 3.1390], style: { fill: '#3B82F6' } },
                    { name: 'Singapore', coords: [103.8198, 1.3521], style: { fill: '#3B82F6' } }
                ],
                markerStyle: {
                    initial: {
                        r: 6,
