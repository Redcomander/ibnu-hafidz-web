    ...
    <header class="article-header relative">
        ...
        <div class="container mx-auto px-4 py-24 relative z-10">
            <div class="max-w-4xl mx-auto text-center" data-aos="fade-up" data-aos-duration="800">
                ...
                <!-- Find the article header section with author info and add the view count -->
                    <div class="flex flex-wrap items-center justify-center space-x-6 text-white">
                        ...
                        <div class="flex flex-col items-center">
                            <span class="text-sm opacity-80 flex items-center">
                                ...
                                {{ number_format($viewsCount ?? 0) }} views
                            </span>
                        </div>
                    </div>
                </div>
                    ...
                    <aside class="col-span-12 lg:col-span-4" data-aos="fade-left">
                        ...
                        <div class="sidebar-widget mb-8">
                            <h3 class="sidebar-widget-title">
                                <i class="fas fa-chart-bar text-green-600 mr-2"></i>Article Stats
                            </h3>
                            <div class="p-4">
                                <div class="flex items-center justify-between mb-3 pb-3 border-b border-gray-100">
                                    <span class="text-sm text-gray-600">Total Views</span>
                                    <span class="font-semibold text-gray-800">{{ number_format($viewsCount ?? 0) }}</span>
                                </div>
                                <div class="flex items-center justify-between mb-3 pb-3 border-b border-gray-100">
                                    <span class="text-sm text-gray-600">Unique Visitors</span>
                                    <span class="font-semibold text-gray-800">{{ number_format($uniqueViewsCount ?? 0) }}</span>
                                </div>
                                <div class="flex items-center justify-between mb-3 pb-3 border-b border-gray-100">
                                    <span class="text-sm text-gray-600">Reading Time</span>
                                    <span class="font-semibold text-gray-800">{{ $article->reading_time ?? '5 min read' }}</span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <span class="text-sm text-gray-600">Published</span>
                                    <span class="font-semibold text-gray-800">{{ $article->published_at ? $article->published_at->format('M d, Y') : 'Draft' }}</span>
                                </div>
                            </div>
                        </div>
